              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="modifyMyInfo" method="get">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName" value='<sec:authentication property="principal.memberVO.m_name"/>' readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail">#Email address</label>
                        <input type="email" class="form-control" id="exampleInputEmail" readonly>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputAddress">#주소</label>
                        <textarea class="form-control" id="exampleInputAddress" rows="2" readonly></textarea>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputTel">#전화번호</label>
                        <input type="text" class="form-control" id="exampleInputTel" readonly>
                      </div>
                      <div class="form-group">
