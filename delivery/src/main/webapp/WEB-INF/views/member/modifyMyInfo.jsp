          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">#내정보 수정하기</h4>
                    <p class="card-description"> #Basic form elements </p>
                    <form class="forms-sample" action="modifyMyInfo" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="address" class="form-control" id="exampleInputAddress" rows="2"></textarea>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputTel">#전화번호</label>
                        <input type="text" name="tel" class="form-control" id="exampleInputTel">
                      </div>                                                
                      <button type="submit" class="btn btn-inverse-warning btn-fw" id="modify">#수정하기</button>
